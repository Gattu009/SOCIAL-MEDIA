...
.snav a:hover
{
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <span class="navbar-text" style="position:fixed;top:4px;right:28px">
      ...
      <div class="column">
        <?php echo " <p style='position:fixed;left:1389px;padding-bottom:8px;top:17px;color:white;font-size:21px'>$username</p>";  ?>
      </div>
    </div>
  ...
  <a href="#" class="w3-bar-item w3-button"><i style="font-size:24px" class="fa">&#xf03e;</i>My Uploads</a>
