...
.snav a:hover
{
  ...
  <a class="navbar-brand" href="#"><i style="font-size:24px" class="fa">&#xf124;</i>MISSIVE</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#"><i style="font-size:30px; position: fixed ;top:9px;right:320px;" class="fa">&#xf110;</i></a>
      </li>
    </ul>
    ...
    <span class="navbar-text" style="position:fixed;top:4px;right:28px">
      ...
      <div class="column">
        <?php echo " <p style="color:black;font-size:21px">$us</p>";  ?>
      </div>
  ...
  <!-- <div class="tnav" >
    ...
    <div class="snav" >
      <div class="w3-sidebar  w3-bar-block" style="width:20%;margin-top:-1px;margin-left: -3px; background-color:#cfcfcf;color:black">
  ...
  <a href="#" class="w3-bar-item w3-button"><i style="font-size:24px" class="fa">&#xf1b0;</i>Change DP</a>
  <a href="#" class="w3-bar-item w3-button"><i style="font-size:24px" class="fa">&#xf011;</i>LogOut</a>
</div>
        ...
        <img src=\"$dp\" alt="Avatar" class="avatar"/> 
         ...
         "<p>"."$username"."</p>";
           ...
           "#"."$location"."</td>"
             ...
             "<br>"
             "<tr>"
            "<tr><td>"."<img class=\"iim\"src=\"$img\" width=\"805px\" height=\"500px\"\>"."</td></tr>"
             "<br>"
           "<td>"."$body"."</td>"
           "<br>"
            "</tr>"
             "<tr>"
          "<td>"
             "<a class="likes"><i  id="like" class="fa fa-thumbs-up fa-2x"></i></a>
