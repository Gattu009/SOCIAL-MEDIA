...
if(isset($_POST['sub']))
  ...
  $co = mysqli_connect($server2,$username2,$password2,$db);
...
$arr=array();
  ...
  $conn = mysqli_connect($server1,$username1,$password1,$db);
...
{
$sql="INSERT INTO `test1`.`trans` (`user`, `frwd`, `message`, `dt`, `tim`) VALUES ('$user', '$frwd','$msg', current_timestamp(),current_timestamp() );";
...
<span class="navbar-text" style="position:fixed;top:4px;right:28px">
      <?php echo " <img src='$dp' alt='Avatar' class='center zoom avatar' style='width:40px;border-radius:50%; height: 40px;position:fixed;top:10px;right:150px'>";?>
      <div class="dropdown" style="float:right;">
        <div class="row">
      <div class="column" style="width:2%;">
      </div>
      <div class="column">
        <?php echo " <p style='position:fixed;left:1389px;padding-bottom:8px;top:17px;color:white;font-size:21px'>$us</p>";  ?>
      </div>
    </div>
  ...
  <div class="dropdown-content"style="background-color:grey;top:40px;">
