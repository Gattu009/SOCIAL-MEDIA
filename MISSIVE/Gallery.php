      ...
      $dp=$_SESSION['dp'];
        ...
        while($row = $a->fetch_assoc()) 
        {
          ...
          echo '<div class="inner-body">';
            ...
            echo "<div class='row' >
  <div class='column'>
    <img src=\"$img\" style='width:300px;height:200px;position:absolute;top:$x;left:$i'>
 ...
 <div class="snav" >
  ...
  <a href="login.php" class="w3-bar-item w3-button"><i style="font-size:24px" class="fa">&#xf011;</i></a>
    ...
    <div class='rowww'>
      ...
      <a href='#'><div class='coll-25' style='background-color:#5d6569;font-size: 18;'>Gallery</div></a>
